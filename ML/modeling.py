...
def tuneModel(dataSet, tuneModelConfiguration, randomSeed=None, n_jobs=1):
    ...
    tuneModelResult = types.TuneModelResult('Tuned ' + tuneModelConfiguration.description \
...
def applyModel(applyModelConfiguration):
    ...
    applyModelResult = types.ApplyModelResult(applyModelConfiguration.description.replace('Apply', 'Result:'),
                                                          testPredictions,
...
def scoreModel(applyModelResult, modelScoreMethods):
    ...
    for modelScoreMethod in modelScoreMethods:
        ...
        modelScore = types.ModelScore(score, modelScoreMethod)
        modelScores.append(modelScore)

    scoreModelResult = types.ScoreModelResult(applyModelResult.description + ', Test Score',
