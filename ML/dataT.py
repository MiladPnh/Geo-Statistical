...
def scaleDataSet(dataSet):
    ...
    scaledDataSet = types.DataSet(newDescription,
                                              newPath,
                                              'w',
                                              completeDataFrame,
    ...
    scaler = types.Scaler(dataSet, minMaxScaler)
...
def engineerFeaturesForDataSet(dataSet, featureEngineeringConfiguration):
    ...
    if featureEngineeringConfiguration.selectionOrExtraction == 'selection':
        if featureEngineeringConfiguration.method == types.ExtractSpecificFeatures:
    ...
    selectedFeaturesDataSet = types.DataSet(newDescription,
                                                        newPath,
                                                        'w',
                                                        completeDataFrame,
                                                        dataSet.featuresIndex,
    ...
    transformer = types.Transformer(featureEngineeringConfiguration.description,
...
def engineerFeaturesByTransformer(dataSet, transformer):
    ...
    if transformer.selectionOrExtraction == 'selection':
        if type(transformer.transformingObject) == types.ExtractSpecificFeatures:
...
def splitDataSet(dataSet, testProportion, randomSeed=None, trainPath=None, testPath=None):
    ...
    trainDataSet = types.DataSet(baseNewDescription + ' Training Set',
                                             trainPath,
                                             'w',
                                             trainDataFrame,
                                             dataSet.featuresIndex,
                                             dataSet.labelIndex)
    testDataSet = types.DataSet(baseNewDescription + ' Testing Set',
                                            testPath,
                                            'w',
                                            testDataFrame,
                                            dataSet.featuresIndex,
    ...
    theSplitDataSet = types.SplitDataSet(trainDataSet, testDataSet)
...
def kFoldSplitDataSet(dataSet, numberOfFolds=3, randomSeed=None, trainPathPrefix=None, testPathPrefix=None):
    ...
    for trainIndex, testIndex in kFoldIndices:
        ...
        trainDataSet = types.DataSet(baseNewDescription + ' ' + str(currentFold) + ' Training Set',
                                                 trainPath,
                                                 'w',
                                                 trainDataFrame,
                                                 dataSet.featuresIndex,
                                                 dataSet.labelIndex)
        testDataSet = types.DataSet(baseNewDescription + ' ' + str(currentFold) + ' Testing Set',
                                                testPath,
                                                'w',
                                                testDataFrame,
                                                dataSet.featuresIndex,
        ...
        # Join into new SplitDataSet
        foldDataSet = types.SplitDataSet(trainDataSet, testDataSet)
