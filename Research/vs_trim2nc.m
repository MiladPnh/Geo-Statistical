...
%  $Id: vs_trim2nc.m 13203 2017-03-08 16:03:11Z ymzkala.x $
%  $Date: 2017-03-09 00:03:11 +0800 (Thu, 09 Mar 2017) $
%  $Author: ymzkala.x $
%  $Revision: 13203 $
...
%% 1a Create file (add all NEFIS 'map-version' group info)
      ...
      nc.Attributes(end+1) = struct('Name','history'            ,'Value', ['Original filename: ',filenameext(vsfile),...
                                         ', ' ,M.version,...
                                         ', file date:',M.datestr,...
                                         ', transformation to netCDF: $HeadURL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/matlab/applications/delft3d/vs_trim2nc.m $ $Id: vs_trim2nc.m 13203 2017-03-08 16:03:11Z ymzkala.x $']);
